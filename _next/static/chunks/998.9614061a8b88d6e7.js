"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[998],{4998:function(e,t,r){r.d(t,{Q:function(){return m}});var i=r(1119),a=r(2265),o=r(1448),n=r(9285);let l=parseInt(o.REVISION.replace(/\D+/g,""));class s extends o.ShaderMaterial{constructor(e=new o.Vector2){super({uniforms:{inputBuffer:new o.Uniform(null),depthBuffer:new o.Uniform(null),resolution:new o.Uniform(new o.Vector2),texelSize:new o.Uniform(new o.Vector2),halfTexelSize:new o.Uniform(new o.Vector2),kernel:new o.Uniform(0),scale:new o.Uniform(1),cameraNear:new o.Uniform(0),cameraFar:new o.Uniform(1),minDepthThreshold:new o.Uniform(0),maxDepthThreshold:new o.Uniform(1),depthScale:new o.Uniform(0),depthToBlurRatioBias:new o.Uniform(.25)},fragmentShader:`#include <common>
      ...
      `)}get tDiffuse(){return this._tDiffuse.value}set tDiffuse(e){this._tDiffuse.value=e}get tDepth(){return this._tDepth.value}set tDepth(e){this._tDepth.value=e}get distortionMap(){return this._distortionMap.value}set distortionMap(e){this._distortionMap.value=e}get tDiffuseBlur(){return this._tDiffuseBlur.value}set tDiffuseBlur(e){this._tDiffuseBlur.value=e}get textureMatrix(){return this._textureMatrix.value}set textureMatrix(e){this._textureMatrix.value=e}get hasBlur(){return this._hasBlur.value}set hasBlur(e){this._hasBlur.value=e}get mirror(){return this._mirror.value}set mirror(e){this._mirror.value=e}get mixBlur(){return this._mixBlur.value}set mixBlur(e){this._mixBlur.value=e}get mixStrength(){return this._blurStrength.value}set mixStrength(e){this._blurStrength.value=e}get minDepthThreshold(){return this._minDepthThreshold.value}set minDepthThreshold(e){this._minDepthThreshold.value=e}get maxDepthThreshold(){return this._maxDepthThreshold.value}set maxDepthThreshold(e){this._maxDepthThreshold.value=e}get depthScale(){return this._depthScale.value}set depthScale(e){this._depthScale.value=e}get depthToBlurRatioBias(){return this._depthToBlurRatioBias.value}set depthToBlurRatioBias(e){this._depthToBlurRatioBias.value=e}get distortion(){return this._distortion.value}set distortion(e){this._distortion.value=e}get mixContrast(){return this._mixContrast.value}set mixContrast(e){this._mixContrast.value=e}}let m=a.forwardRef(({mixBlur:e=0,mixStrength:t=1,resolution:r=256,blur:l=[0,0],minDepthThreshold:s=.9,maxDepthThreshold:m=1,depthScale:f=0,depthToBlurRatioBias:v=.25,mirror:d=0,distortion:c=1,mixContrast:p=1,distortionMap:x,reflectorOffset:_=0,...g},D)=>{(0,n.e)({MeshReflectorMaterialImpl:h});let U=(0,n.D)(({gl:e})=>e),S=(0,n.D)(({camera:e})=>e),T=(0,n.D)(({scene:e})=>e),B=(l=Array.isArray(l)?l:[l,l])[0]+l[1]>0,w=a.useRef(null);a.useImperativeHandle(D,()=>w.current,[]);let[M]=a.useState(()=>new o.Plane),[y]=a.useState(()=>new o.Vector3),[F]=a.useState(()=>new o.Vector3),[b]=a.useState(()=>new o.Vector3),[R]=a.useState(()=>new o.Matrix4),[C]=a.useState(()=>new o.Vector3(0,0,-1)),[E]=a.useState(()=>new o.Vector4),[V]=a.useState(()=>new o.Vector3),[z]=a.useState(()=>new o.Vector3),[A]=a.useState(()=>new o.Vector4),[P]=a.useState(()=>new o.Matrix4),[k]=a.useState(()=>new o.PerspectiveCamera),I=a.useCallback(()=>{var e;let t=w.current.parent||(null==(e=w.current)?void 0:e.__r3f.parent);if(!t||(F.setFromMatrixPosition(t.matrixWorld),b.setFromMatrixPosition(S.matrixWorld),R.extractRotation(t.matrixWorld),y.set(0,0,1),y.applyMatrix4(R),F.addScaledVector(y,_),V.subVectors(F,b),V.dot(y)>0))return;V.reflect(y).negate(),V.add(F),R.extractRotation(S.matrixWorld),C.set(0,0,-1),C.applyMatrix4(R),C.add(b),z.subVectors(F,C),z.reflect(y).negate(),z.add(F),k.position.copy(V),k.up.set(0,1,0),k.up.applyMatrix4(R),k.up.reflect(y),k.lookAt(z),k.far=S.far,k.updateMatrixWorld(),k.projectionMatrix.copy(S.projectionMatrix),P.set(.5,0,0,.5,0,.5,0,.5,0,0,.5,.5,0,0,0,1),P.multiply(k.projectionMatrix),P.multiply(k.matrixWorldInverse),P.multiply(t.matrixWorld),M.setFromNormalAndCoplanarPoint(y,F),M.applyMatrix4(k.matrixWorldInverse),E.set(M.normal.x,M.normal.y,M.normal.z,M.constant);let r=k.projectionMatrix;A.x=(Math.sign(E.x)+r.elements[8])/r.elements[0],A.y=(Math.sign(E.y)+r.elements[9])/r.elements[5],A.z=-1,A.w=(1+r.elements[10])/r.elements[14],E.multiplyScalar(2/E.dot(A)),r.elements[2]=E.x,r.elements[6]=E.y,r.elements[10]=E.z+1,r.elements[14]=E.w},[S,_]),[N,L,W,j]=a.useMemo(()=>{let i={minFilter:o.LinearFilter,magFilter:o.LinearFilter,type:o.HalfFloatType},a=new o.WebGLRenderTarget(r,r,i);a.depthBuffer=!0,a.depthTexture=new o.DepthTexture(r,r),a.depthTexture.format=o.DepthFormat,a.depthTexture.type=o.UnsignedShortType;let n=new o.WebGLRenderTarget(r,r,i),h=new u({gl:U,resolution:r,width:l[0],height:l[1],minDepthThreshold:s,maxDepthThreshold:m,depthScale:f,depthToBlurRatioBias:v}),_={mirror:d,textureMatrix:P,mixBlur:e,tDiffuse:a.texture,tDepth:a.depthTexture,tDiffuseBlur:n.texture,hasBlur:B,mixStrength:t,minDepthThreshold:s,maxDepthThreshold:m,depthScale:f,depthToBlurRatioBias:v,distortion:c,distortionMap:x,mixContrast:p,"defines-USE_BLUR":B?"":void 0,"defines-USE_DEPTH":f>0?"":void 0,"defines-USE_DISTORTION":x?"":void 0};return[a,n,h,_]},[U,l,P,r,d,B,e,t,s,m,f,v,c,x,p]);return(0,n.F)(()=>{var e;let t=w.current.parent||(null==(e=w.current)?void 0:e.__r3f.parent);if(!t)return;t.visible=!1;let r=U.xr.enabled,i=U.shadowMap.autoUpdate;I(),U.xr.enabled=!1,U.shadowMap.autoUpdate=!1,U.setRenderTarget(N),U.state.buffers.depth.setMask(!0),U.autoClear||U.clear(),U.render(T,k),B&&W.render(U,N,L),U.xr.enabled=r,U.shadowMap.autoUpdate=i,t.visible=!0,U.setRenderTarget(null)}),a.createElement("meshReflectorMaterialImpl",(0,i.Z)({attach:"material",key:"key"+j["defines-USE_BLUR"]+j["defines-USE_DEPTH"]+j["defines-USE_DISTORTION"],ref:w},j,g))})}}]);